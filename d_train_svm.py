...
pickle.dump(scaler,open('Project_Extra/d_scaler_svm.pkl','wb'))
...
plt.savefig('Project_Extra/d_confusion_matrix_svm.png')
plt.show()
...
# model saving
filename1 = "Project_Saved_Models/d_Trained_SVM_model.sav"
